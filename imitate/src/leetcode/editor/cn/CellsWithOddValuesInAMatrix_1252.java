...
// Related Topics 数组 数学 模拟 👍 69 👎 0

  
  package leetcode.editor.cn;
  public class CellsWithOddValuesInAMatrix_1252{
      public static void main(String[] args) {
           Solution solution = new CellsWithOddValuesInAMatrix_1252().new Solution();
      }
...
}//执行耗时:1 ms,击败了57.74% 的Java用户 内存消耗:39.8 MB,击败了5.16% 的Java用户
